    ...
    <div className="CityDetailsPage">
      ...
      <div className="house-stats-box">
        <div className="min-bed-box">
          <h2>Min Bedroom</h2>
          <select placeholder="Any bedroom"></select>
        </div>

        <div className="min-bath-box">
          <h2>Min Bathrooms</h2>
          <select placeholder="Any bathroom"></select>
        </div>

        <div className="max-price">
          <h2>Max Price</h2>
          <select placeholder="Any Price"></select>
        </div>

        <div className="home-type-box">
          <h2>Home Type</h2>
          <select placeholder="Any Type"></select>
        </div>
      </div>
      ...
      <div className="city-info">
        <div className="info">
          ...
          <p className="info-para"> {singleCity?.data[0].student_life} </p>
        </div>
